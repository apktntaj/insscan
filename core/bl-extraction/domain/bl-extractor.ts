 ...
 */
const FIELD_PATTERNS: Record<string, FieldConfig> = {
  blNumber: {
    patterns: [
...
function extractField(
  ...
  const candidates: Array<ExtractedField & { priority: number }> = [];
 ...
 * // }
 */
export function extractBLFields(text: string): ExtractionResult {
 ...
 * @returns {ExtractedField}
 */
function normalizeDate(dateStr: string): ExtractedField {
