...
import {
  ...
  type Alert,
  type AlertResult,
} from "./evaluate-data-quality-alerts";
 ...
 * // => false
 */
export function isOverdue(etaDate: Date, today: Date): boolean {
 ...
 * // => false  (4 days away)
 */
export function isArrivingSoon(etaDate: Date, today: Date): boolean {
 ...
 */
export function isStaleEntry(shipment: StaleShipment, today: Date): boolean {
 ...
 */
export function evaluateShipmentStatusAlerts(
  shipments: readonly StatusAlertShipment[],
