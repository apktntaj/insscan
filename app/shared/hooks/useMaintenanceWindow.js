...
import { maintenanceWindows } from "@/app/shared/config/maintenance-config";
 ...
 * @returns {{ isUnderMaintenance: boolean, config: import("@/app/shared/config/maintenance-config").MaintenanceWindow | null }}
 *
 * @example
