 ...
 *
 * Menampilkan teks penjelasan dan link WhatsApp untuk mengirim saran.
 ...
 * <SuggestionForm waNumber="6281234567890" />
 ...
 * <SuggestionForm waNumber="628111222333" />
  ...
  return (
    <section aria-labelledby="suggestion-heading">
      ...
      <p className="mt-2 text-sm leading-7 text-zinc-600">
        Ada ide fitur baru atau masukan untuk perbaikan? Langsung chat via WhatsApp — lebih cepat dan tidak perlu isi form panjang.
      </p>
      <p className="mt-1 text-sm leading-7 text-zinc-500">
        Saran kamu akan langsung dibaca oleh developer dan jadi bahan pertimbangan untuk roadmap berikutnya.
      </p>
      <div className="mt-5">
        <a
          href={waUrl}
