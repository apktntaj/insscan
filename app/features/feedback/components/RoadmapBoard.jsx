 ...
 *
 * @param {import("@/app/features/feedback/config/feedback-config").FeatureStatus} status
 ...
 *
 * @param {import("@/app/features/feedback/config/feedback-config").FeatureItem[]} items
 * @returns {import("@/app/features/feedback/config/feedback-config").FeatureItem[]} array baru yang terurut
 *
 * @example
 * sortByStatus([
 ...
 *
 * @param {{ items: import("@/app/features/feedback/config/feedback-config").FeatureItem[] }} props
 * @returns {JSX.Element}
 *
 * @example
