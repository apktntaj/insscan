 ...
 *
 * @param {Object} deps
 * @param {{ execute: (input: { itemDescription: import('@core/hs-finder/domain/hs-finder').ItemDescription }) => Promise<import('@core/hs-finder/use-cases/find-hs-code').FindHsCodeResult> }} deps.findHsCodeUseCase
...
export function createHsFinderController({
   ...
   * @returns {Promise<{ ok: true, data: import('@core/hs-finder/domain/hs-finder').ClassificationResult } | { ok: false, errorCode: string, errorMessage: string }>}
   *
   * @example
