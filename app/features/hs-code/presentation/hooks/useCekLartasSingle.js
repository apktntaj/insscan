...
import { parseHsCodeApiResponse } from "@/app/features/hs-code/adapters/presenters/hs-code.presenter";
...
import { useQueryLimit } from "@/app/features/hs-code/presentation/hooks/useQueryLimit";
 ...
 * @returns {Promise<{ ok: true, data: import('@/app/features/hs-code/adapters/presenters/hs-code.presenter').LartasResult } | { ok: false, error: string }>}
 *
 * @example
 ...
 *
 * @param {import('@/app/features/hs-code/adapters/presenters/hs-code.presenter').LartasResult} result
 * @returns {Array<{
 *   "HS Code": string,
...
function buildSingleExcelRows(result) {
  ...
  /** @param {import('@/app/features/hs-code/adapters/presenters/hs-code.presenter').LartasDetail} detail */
 ...
 *
 * @returns {import('@/app/features/hs-code/adapters/presenters/hs-code.presenter').SingleHookReturn}
 *
 * @example
