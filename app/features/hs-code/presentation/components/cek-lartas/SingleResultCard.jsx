...
import { formatHsCode } from "@core/hs-code/domain/hs-code";
 ...
 *
 * @param {{ label: string, details: import('@/app/features/hs-code/adapters/presenters/hs-code.presenter').LartasDetail[] }} props
 */
 ...
 *
 * @param {{
 *   row: import('@/app/features/hs-code/adapters/presenters/hs-code.presenter').LartasResult,
 *   onCopy: () => Promise<void>,
 *   onExport: () => void
 * }} props
 */
