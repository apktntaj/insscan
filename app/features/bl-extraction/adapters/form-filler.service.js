 ...
 * 
 * @param {import('@core/bl-extraction/domain/bl-extractor').ExtractionResult} extraction
 * @returns {FormData}
 * 
 * @example
 ...
 * 
 * @param {import('@core/hs-finder/ports/gemini-gateway').ExtractionData} extraction
 * @returns {FormData}
 * 
 * @example
