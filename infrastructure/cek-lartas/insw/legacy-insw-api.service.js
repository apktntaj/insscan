 ...
 *
 * @description Legacy HTTP client wrapped by the typed INSW Source adapter
 */
...
function mapPublicHsCodeToRawData(data) {
  return {
    // Public tariff responses do not prove that LARTAS is absent.
    lartasVerified: false,
...
/**
 * Legacy INSW API gateway wrapped by insw-lartas-data-source.ts
 */
